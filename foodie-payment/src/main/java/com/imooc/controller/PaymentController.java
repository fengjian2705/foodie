...
import tech.fengjian.enums.PayMethod;
import tech.fengjian.enums.PaymentStatus;
import tech.fengjian.utils.CurrencyUtils;
import tech.fengjian.utils.JSONResult;
import tech.fengjian.utils.RedisOperator;
...
public class PaymentController {
	...
	public JSONResult createMerchantOrder(@RequestBody MerchantOrdersBO merchantOrdersBO, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			e.printStackTrace();
			JSONResult.errorMsg(e.getMessage());
		}
